...
//Artinya Sidebar menerima sebuah objek props yang dikirim dari parentcomponent (misalnya dari AdminLayout).
//sidebarOpen sebuah state boolean (true/false) untuk menentukan sidebarsedangterbuka atau tertutup.
